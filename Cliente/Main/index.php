...
<body style="background-color:#E0F3DC">
    ...
    <?php 
        ...
        echo '<center><img class="banner" src="../../Administrador/Promociones/archivos/' . $fila['archivo'] . '" ></center>';
        echo '<br><br>'; 
    ?>
    ...
    $sql = "SELECT * FROM productos WHERE eliminado = 0 ORDER BY RAND()";
